...
ALearningProjectCharacter::ALearningProjectCharacter()
{
...
void ALearningProjectCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ALearningProjectCharacter::Move);
...
void ALearningProjectCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
	...
	if (Controller != nullptr)
	{
		...
		// X is left and right
		// Y is back and forward in platformers
...
void ALearningProjectCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
